...
local dispatchCodes = {
    ...
    melee = { displayCode = '10-70', description = _U('melee'), isImportant = 0, recipientList = {'police'},
    blipSprite = 652, blipColour = 84, blipScale = 0.9 },

    officerdown = {displayCode = '11-99', description = _U('officerdown'), isImportant = 1, recipientList = {'police', 'ambulance'},
    blipSprite = 653, blipColour = 84, blipScale = 0.9, infoM = 'fa-portrait'},

    persondown = {displayCode = '10-53', description = _U('persondown'), isImportant = 0, recipientList = {'police', 'ambulance'},
    blipSprite = 153, blipColour = 84, blipScale = 0.9, infoM = 'fa-portrait'},

    autotheft = {displayCode = '10-73', description = _U('autotheft'), isImportant = 0, recipientList = {'police'},
    blipSprite = 651, blipColour = 84, blipScale = 0.9, infoM = 'fa-car', infoM2 = 'fa-palette' },

    speeding = {displayCode = '10-74', description = _U('speeding'), isImportant = 0, recipientList = {'police'},
    blipSprite = 650, blipColour = 84, blipScale = 0.9, infoM = 'fa-car', infoM2 = 'fa-palette' },

    shooting = { displayCode = '10-71', description = _U('shooting'), isImportant = 0, recipientList = {'police'},
    blipSprite = 119, blipColour = 77, blipScale = 0.9 },

    driveby = { displayCode = '10-71b', description = _U('driveby'), isImportant = 0, recipientList = {'police'},
    blipSprite = 649, blipColour = 84, blipScale = 0.9, infoM = 'fa-car', infoM2 = 'fa-palette' },
}


--[[Example custom alert
RegisterCommand('test', function(playerId, args, rawCommand)
    local data = {displayCode = '211', description = 'Robbery', isImportant = 0, recipientList = {'police'}, length = '10000', infoM = 'fa-info-circle', info = 'Vangelico Jewelry Store', blipSprite = 161, blipScale = 0.9, blipColour = 1}
...
AddEventHandler('wf-alerts:svNotify911', function(message, caller, coords)
    if message ~= nil then
        ...
        pData.sprite, pData.colour, pData.scale =  480, 84, 0.9 -- radar_vip, blue
        local xPlayers = ESX.GetPlayers()
		for i= 1, #xPlayers do
            local source = xPlayers[i]
            local xPlayer = ESX.GetPlayerFromId(source)
